package com.sriram.wifidirect.utils;
...
public class CustomCheckBox extends View implements Checkable {
    ...
    private static final int DEF_DRAW_SIZE = 400;
    private static final int DEF_ANIM_DURATION = 50;
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.CustomCheckBox_stroke_width, dp2px(getContext(), 100));
